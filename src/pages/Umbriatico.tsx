...
const Umbriatico = () => {
  ...
  const bookingUrl =
    language === "ru"
      ? "https://t.me/+393446935576"
      : "https://wa.me/393446935576";
    ...
    >
      ...
      >
        ...
        <div className="relative container mx-auto px-4 py-24 text-center">
          <h1 className="font-serif text-4xl md:text-6xl font-bold mb-4 inline-block bg-black/40 px-4 py-2 rounded">
            {content.title}
          </h1>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-center gap-3">
                      <Clock className="w-5 h-5 text-[#0077B6]" aria-hidden="true" />
                      <span className="text-gray-600">{content.duration}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Euro className="w-5 h-5 text-[#0077B6]" aria-hidden="true" />
                      <span className="text-gray-600">{content.price}</span>
                    </div>
                    
                    <div className="flex items-center gap-3">
                      <Users className="w-5 h-5 text-[#0077B6]" aria-hidden="true" />
                      <span className="text-gray-600">{content.groupSize}</span>
                    </div>
                    
                    <div className="flex items-start gap-3">
                      <MapPin className="w-5 h-5 text-[#0077B6] mt-0.5" aria-hidden="true" />

...
const places: Place[] = [
  ...
  },
  {
    ...
    description_ru: "Пекарня, свежие итальянские булочки и не только. Рядом с пляжем.",
    description_en: "Traditional Italian bakery with fresh rolls and more. Located near the beach.",
